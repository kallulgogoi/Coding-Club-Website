...
export default function CauldronPage() {
  ...
  const hallOfFame = [
    { name: "Smitkri", handle: "@smitkri", rank: "Master", img: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?q=80&w=200&auto=format&fit=crop" },
    { name: "Tourist", handle: "@tourist", rank: "Legendary Grandmaster", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=200&auto=format&fit=crop" },
    { name: "Radewoosh", handle: "@Radewoosh", rank: "Legendary Grandmaster", img: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=200&auto=format&fit=crop" },
  ];
    ...
    <main className="min-h-screen bg-black overflow-x-hidden font-['Rajdhani']">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center space-y-8 mt-12">
          ...
          >
            The Ultimate Competitive Programming Showdown. Forge your legacy in the crucible of algorithmic excellence.
          </motion.p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 space-y-8">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-yellow-400/20 bg-yellow-400/5 text-yellow-400">
              ...
              <span className="text-xs uppercase font-bold tracking-wider">Organized by Coding Club NIT Silchar</span>
            </div>
            ...
            <p className="text-gray-400 text-lg sm:text-xl leading-relaxed font-medium">
              Cauldron is an annual flagship competitive programming contest that challenges the brightest minds 
              to solve complex algorithmic puzzles under immense pressure. It is a grueling test of logic, mathematics, 
              and optimization, designed to push participants to their absolute limits.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 flex flex-col items-start gap-4 hover:border-yellow-400/30 transition-colors">
                ...
                <div>
                  <h4 className="text-white font-bold text-lg mb-1">Global Stage</h4>
                  <p className="text-sm text-gray-500">Compete on Codeforces with top talents from around the world.</p>
                </div>
              </div>
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 flex flex-col items-start gap-4 hover:border-yellow-400/30 transition-colors">
                <Shield className="w-8 h-8 text-yellow-400" />
                <div>
                  <h4 className="text-white font-bold text-lg mb-1">High Stakes</h4>
                  <p className="text-sm text-gray-500">Exciting cash prizes and the ultimate bragging rights await.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-[#080808] border border-white/5 text-center flex flex-col items-center gap-4 hover:border-yellow-400/50 transition-colors group">
                ...
                <h3 className="text-4xl font-black text-white font-['Orbitron']">{stat.value}</h3>
          ...
          <div className="mt-16 bg-[#0a0a0a] border border-white/10 rounded-3xl p-8 sm:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 flex-1">
              <h3 className="text-2xl font-black text-white uppercase font-['Orbitron']">Dive Into The Archives</h3>
              <p className="text-gray-400">Want to test your mettle? Try out the problems from last year's Cauldron.</p>
            </div>
            <a 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <div className="inline-flex items-center gap-2 justify-center mb-4">
              ...
              <span className="text-yellow-400 font-bold tracking-widest uppercase text-sm">Champions</span>
              <Trophy className="w-6 h-6 text-yellow-400" />
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase font-['Orbitron'] tracking-tighter">
          ...
          >
            {hallOfFame.map((winner, idx) => (
              ...
              >
                <div className={`absolute -inset-1 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-md ${idx === 1 ? 'bg-yellow-400/40' : 'bg-white/20'}`} />
                <div className={`relative p-8 rounded-3xl bg-[#080808] border ${idx === 1 ? 'border-yellow-400/50 scale-105 z-10 shadow-[0_0_30px_rgba(250,204,21,0.15)] md:-translate-y-6' : 'border-white/10'} flex flex-col items-center text-center h-full transition-transform duration-300`}>
                  ...
                  <div className="relative w-32 h-32 mb-6">
                    ...
                    />
                    <div className={`absolute -bottom-4 left-1/2 -translate-x-1/2 w-10 h-10 rounded-full flex items-center justify-center border-4 border-[#080808] ${idx === 1 ? 'bg-yellow-400 text-black' : 'bg-gray-700 text-white'}`}>
                      <span className="font-black font-['Orbitron']">{idx === 1 ? '1' : idx === 0 ? '2' : '3'}</span>
                    </div>
                  </div>

                  <h3 className="text-2xl font-black text-white mb-1 font-['Orbitron']">{winner.name}</h3>
                  <p className="text-yellow-400 font-medium mb-3">{winner.handle}</p>
                  <p className="text-sm text-gray-500 uppercase tracking-widest font-bold">{winner.rank}</p>
